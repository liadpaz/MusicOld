...
import com.liadpaz.amp.ui.adapters.ExtendedViewPagerAdapter
...
import com.liadpaz.amp.server.service.ServiceConnector.Companion.getInstance
...
class ExtendedViewPagerFragment : Fragment() {
    ...
    companion object {
        private const val TAG = "AmpApp.ExtendedViewPagerFragment"
