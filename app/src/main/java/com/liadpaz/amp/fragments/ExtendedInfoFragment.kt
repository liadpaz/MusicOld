...
class ExtendedInfoFragment : Fragment() {
    private val TAG = "AmpApp.ExtendedInfoFragment"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        binding.btnQueue.setOnClickListener { v: View ->
            parentFragmentManager.beginTransaction().replace(R.id.layoutFragment, if (isShowingQueue) ExtendedViewPagerFragment.newInstance() else CurrentQueueFragment.Companion.newInstance()).commit()
