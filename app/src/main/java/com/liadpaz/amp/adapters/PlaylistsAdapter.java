...
public class PlaylistsAdapter extends ListAdapter<Playlist, PlaylistsAdapter.PlaylistViewHolder> {
    ...
    public PlaylistsAdapter(@NonNull Context context, @NonNull OnRecyclerItemClickListener onClickListener) {
    ...
    public PlaylistViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new PlaylistViewHolder(ItemPlaylistBinding.inflate(LayoutInflater.from(context), parent, false), onClickListener);
    }
    ...
    static class PlaylistViewHolder extends RecyclerView.ViewHolder {
        ...
        PlaylistViewHolder(@NonNull ItemPlaylistBinding binding, @NonNull OnRecyclerItemClickListener onClickListener) {
